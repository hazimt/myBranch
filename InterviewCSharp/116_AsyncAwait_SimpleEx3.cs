...
namespace TestCases
{
    class asyncProgramEx3
    {     
        static async void CallMethod()  
        {  
            string filePath = @"C:\Users\Mars\source\myBranch\InterviewCSharp\InterviewQuestionsVisualCode\Files\sampleFile.txt";  
    ...
    public class asyncTaskDriverSimpleEx3
    {
        //Driver Function like main
        public void driverCall()
        {
            Console.WriteLine(" ............  ");
            Console.WriteLine(" 115_AsyncAwait_TaskWait_SimpleEx3.cs  ");
...
Done
 ............
 115_AsyncAwait_TaskWait_SimpleEx3.cs
0: Method 1
1: Method 1
2: Method 1
3: Method 1
